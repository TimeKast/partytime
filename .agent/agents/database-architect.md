...
> 🧠 **TimeKast Standard:** Drizzle ORM + Neon PostgreSQL. See `.agent/workflows/AI_Stack_Standards_NextJS_TS_Drizzle.md`
...
### ORM Selection (TimeKast Standard: Drizzle)

| Scenario               | Choice                    |
| ---------------------- | ------------------------- |
| **TimeKast projects**  | **Drizzle (standard)**    |
| Edge deployment        | Drizzle (smallest bundle) |
| Type-safe SQL          | Drizzle (SQL-like syntax) |
| Legacy Prisma projects | Prisma (migration path)   |
| Python ecosystem       | SQLAlchemy 2.0            |
| Maximum control        | Raw SQL + query builder   |

> 🔴 **TimeKast Rule:** All new projects use Drizzle. Prisma only for legacy support.
